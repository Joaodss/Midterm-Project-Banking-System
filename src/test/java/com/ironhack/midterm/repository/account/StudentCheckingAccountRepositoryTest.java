...
class StudentCheckingAccountRepositoryTest {
  ...
  void testFindByUsernameJoined_validUsername_returnCheckingAccountWithTransaction() {
    var element1 = studentCheckingAccountRepository.findAllByUsernameJoined("joa0ds5");
    assertFalse(element1.isEmpty());
    assertTrue(element1.contains(sca1));
    assertTrue(element1.contains(sca2));
    assertFalse(element1.contains(sca3));
  }

  @Test
  @Order(8)
  void testFindByUsernameJoined_invalidUsername_returnCheckingAccountWithTransaction() {
    var element1 = studentCheckingAccountRepository.findAllByUsernameJoined("noooooooo");
    assertTrue(element1.isEmpty());
  }
